...
// Inclui biblioteca para habilitar os métodos 
...
void loop() 
{
 //Realiza as leituras do acelerômetro,giroscopio e do sensor de temperatura.

 mpu.getEvent(&acc,&gyr,&temp);
 
 // Mostra na tela as leituras realizadasno Monitor Serial
 ...
 /*
     // Mostra as leituras realizadas no Plotter Serial, antes
     // descomente o trecho de código referente ao Monitor Serial
     
     //Descomente para mostrar as leituras do acelerômetro 
     //no Plotter Serial
     ...
     //Descomente para mostrar as leituras do giroscópio 
     //no Plotter Serial
